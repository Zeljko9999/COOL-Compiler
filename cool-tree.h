...
//
// add getter for node classes.
// for the sake of convenient,
// directly implement it in this
// header file.
//
...
class class__class : public Class__class {
    ...
    public:
        ...
        Class_ copy_Class_();
        void dump(ostream& stream, int n);
        Node_type  get_type()       { return classType; } 
...
class method_class : public Feature_class {
    ...
    public:
        ...
        void dump(ostream& stream, int n);
        Node_type get_type()        { return methodType; }
        Symbol get_name()           { return name; }
...
class attr_class : public Feature_class {
    ...
    public:
        ...
        Feature copy_Feature();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return attrType; }
        Symbol get_name()           { return name; }
...
class formal_class : public Formal_class {
    ...
    public:
        ...
        Formal copy_Formal();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return formalType; }
        Symbol get_name()           { return name; }
        Symbol get_type_decl()      { return type_decl; }
...
class branch_class : public Case_class {
    ...
    public:
        ...
        Case copy_Case();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return branchType; }
        Symbol get_name()           { return name; }
        Symbol get_type_decl()      { return type_decl; }
        Expression get_expr()       { return expr; }
...
class assign_class : public Expression_class {
    ...
    public:
        ...
        void dump(ostream& stream, int n);
        Node_type get_type()    { return assignType; }
        Symbol get_name()       { return name; }
        Expression get_expr()   { return expr; }
...
class static_dispatch_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return static_dispatchType; }
...
class dispatch_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return dispatchType; }
        Expression get_expr()       { return expr; }
        Symbol get_name()           { return name; }
        Expressions get_actual()    { return actual; }
...
class cond_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()            { return condType; }
...
class loop_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return loopType; }
        Expression get_pred()       { return pred; }
...
class typcase_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return caseType; }
        Expression get_expr()       { return expr; }
...
class block_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return blockType; }
...
class let_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()                { return letType; }
...
class plus_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return plusType; }
...
class sub_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return subType; }
        Expression get_e1()         { return e1; }
        Expression get_e2()         { return e2; }
...
class mul_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return mulType; }
        Expression get_e1()         { return e1; }
        Expression get_e2()         { return e2; }
...
class divide_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return divType; }
        Expression get_e1()         { return e1; }
        Expression get_e2()         { return e2; }
...
class neg_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return negType; }
        Expression get_e1()         { return e1; }
...
class lt_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return ltType; }
        Expression get_e1()         { return e1; }
        Expression get_e2()         { return e2; }
...
class eq_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return eqType; }
        Expression get_e1()         { return e1; }
        Expression get_e2()         { return e2; }
...
class leq_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return leqType; }
        Expression get_e1()         { return e1; }
        Expression get_e2()         { return e2; }
...
class comp_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return compType; }
        Expression get_e1()         { return e1; }
...
class int_const_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return int_constType; }
...
class bool_const_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return bool_constType; }
...
class string_const_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return string_constType; }
        Symbol get_token()          { return token; }
...
class new__class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()            { return newType; }
        Symbol get_type_name()          { return type_name; }
...
class isvoid_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return isvoidType; }
        Expression get_e1()         { return e1; }
...
class no_expr_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return no_exprType; }
...
class object_class : public Expression_class {
    ...
    public:
        ...
        Expression copy_Expression();
        void dump(ostream& stream, int n);
        Node_type get_type()        { return objectType; }
        Symbol get_name()           { return name; }
